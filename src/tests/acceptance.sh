...
function tape_setup
{
    ...
    $LOG_VALG $phobos tape list -o all $tp1
...
function dir_setup
{
    ...
    $LOG_VALG $phobos dir list -o all $d1
...
function put_alias
{
    ...
    local id_with_tag=test/hosts-alias8.$$
    ...
    test_single_alias_put $alias_full $id_with_fam "dir" "raid1" "-f dir"
    ...
    test_single_alias_put $alias_full $id_with_tag "dir" "raid1" \
...
function check_status
{
    ...
    for m in $media; do
        $LOG_VALG $phobos $type list -o all "$m"
    done
}
